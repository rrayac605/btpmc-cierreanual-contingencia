package mx.gob.imss.cit.pmc.contingencia.constants;
...
public class ConfrontaConstants {
	...
	public static final String BASE_PATH_SERVER = "/opt/jboss/archivoscierreanual/contingencia/{year}";
	//public static final String BASE_PATH_SERVER = "C:\\opt\\jboss\\archivoscierreanual\\contingencia\\{year}\\{month}\\";
