...
import mx.gob.imss.cit.pmc.contingencia.dto.ChangeDTO;
import mx.gob.imss.cit.pmc.contingencia.dto.MovementDTO;
import mx.gob.imss.cit.pmc.contingencia.listener.JobConfrontaListener;
import mx.gob.imss.cit.pmc.contingencia.listener.MongoProcessorListener;
import mx.gob.imss.cit.pmc.contingencia.listener.MongoReaderListener;
import mx.gob.imss.cit.pmc.contingencia.listener.MongoWriterListener;
import mx.gob.imss.cit.pmc.contingencia.listener.StepConfrontaListener;
import mx.gob.imss.cit.pmc.contingencia.processor.BackupChangeProcessor;
import mx.gob.imss.cit.pmc.contingencia.processor.BackupChangeProcessorContingencia;
import mx.gob.imss.cit.pmc.contingencia.processor.BackupMovementProcessor;
import mx.gob.imss.cit.pmc.contingencia.processor.ConfrontaChangeProcessor;
import mx.gob.imss.cit.pmc.contingencia.processor.ConfrontaMovementProcessor;
import mx.gob.imss.cit.pmc.contingencia.tasklet.AuditFailedTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.AuditTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.FileControlFailedTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.FileValidationTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.FooterTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.GenerateFileSuccessTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.HeaderTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.ProcessControlFailedTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.ProcessControlTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.RollBackTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.SftpUploadFileTasklet;
import mx.gob.imss.cit.pmc.contingencia.tasklet.SuccessProcessValidatorTasklet;
...
import mx.gob.imss.cit.pmc.contingencia.utils.ReaderUtils;
import mx.gob.imss.cit.pmc.contingencia.utils.StringUtils;

@Configuration
@EnableBatchProcessing
@ComponentScan(basePackages = { "mx.gob.imss.cit.pmc.contingencia" })
public class BatchConfiguration extends DefaultBatchConfigurer {
    ...
    @Autowired
    private BackupChangeProcessorContingencia backupChangeProcessorContingencia;
    ...
    public Step backupDescartadosChangeStep() {
        return stepBuilderFactory.get("backupDescartadosChangeStep")
                ...
                .listener(changeReaderListener)
                .processor(backupChangeProcessorContingencia)
                .listener(backupChangeProcessorListener)
                .writer(backupDescartadosWriter())
                .listener(changeWriterListener)
                .listener(stepConfrontaListener)
    ...
    @Bean MongoItemWriter<BackupConfrontaDTO> backupWriter() {
        return new MongoItemWriterBuilder<BackupConfrontaDTO>()
                .template(mongoOperations)
                .collection("MCB_RESPALDO_CIERRE_ANUAL_CONTINGENCIA")
                .build();
    }
    ...
    @Bean MongoItemWriter<BackupConfrontaDTO> backupDescartadosWriter() {
        return new MongoItemWriterBuilder<BackupConfrontaDTO>()
                .template(mongoOperations)
                .collection("MCB_RESPALDO_RIESGOS_DESCARTADOS_CONTINGENCIA")
                .build();
    }
